...
public class Main {
	...
	public static Interaction i11 = Interaction.create(e1, r1, -1);
	public static Interaction i12 = Interaction.create(e1, r2, 1);
	public static Interaction i21 = Interaction.create(e2, r1, -1);
	public static Interaction i22 = Interaction.create(e2, r2, 1);
	...
	public static void main(String[] args){
		...
		for(int i=0 ; i < 10 ; i++){
			...
			System.out.println(experience.getLabel() + "," + result.getLabel() + "," + Interaction.get(experience, result).getValue());
		}
	}
}
